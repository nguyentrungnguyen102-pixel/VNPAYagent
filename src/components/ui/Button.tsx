...
export default function Button({ variant = 'primary', size = 'md', loading, className, children, disabled, ...props }: ButtonProps) {
  ...
  const variants = {
    primary: 'bg-vnpay-blue text-white hover:bg-vnpay-navy focus:ring-vnpay-blue',
    ...
    danger: 'bg-vnpay-red text-white hover:bg-red-700 focus:ring-vnpay-red',
    ghost: 'text-gray-600 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700 focus:ring-gray-400',
    outline: 'border border-vnpay-blue text-vnpay-blue hover:bg-vnpay-blue hover:text-white focus:ring-vnpay-blue dark:border-blue-400 dark:text-blue-400',
  }
  const sizes = {
