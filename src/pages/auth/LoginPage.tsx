    ...
    <div className="min-h-screen bg-gradient-to-br from-vnpay-navy via-vnpay-blue to-blue-500 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center bg-white rounded-2xl shadow-lg mb-4 px-6 py-3">
            <img src="./vnpay-logo.png" alt="VNPAY" className="h-10 object-contain" />
          </div>
